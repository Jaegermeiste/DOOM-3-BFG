...
public:
	...
	void				SetupCylinder( const idBounds &bounds, const size_t numSides );
	void				SetupCone( const idBounds &bounds, const size_t numSides );
...
====================
*/
ID_INLINE idSurface_Polytope::idSurface_Polytope() noexcept {
}
