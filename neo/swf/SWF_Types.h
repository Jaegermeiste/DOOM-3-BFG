...
ID_INLINE float SWFTWIP(const int twip ) { return twip * ( 1.0f / 20.0f ); }
ID_INLINE float SWFFIXED16(const int fixed ) { return fixed * ( 1.0f / 65536.0f ); }
ID_INLINE float SWFFIXED8(const int fixed ) { return fixed * ( 1.0f / 256.0f ); }
