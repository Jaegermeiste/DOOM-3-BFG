...
typedef enum shadowVolumeState_e : uint8 {
	SHADOWVOLUME_DONE		= 0,
...
bool R_ViewInsideShadowVolume( byte * cullBits, const idShadowVert * verts, size_t numVerts, const triIndex_t * indexes, size_t numIndexes,
