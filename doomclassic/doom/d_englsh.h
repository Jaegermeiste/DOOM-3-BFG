...
// Everything below uses either simple literals (`constexpr auto = "..."`)
// or the clean `concat("...", OTHER_CONST, ...)` for composed entries.
//

constexpr auto PLAYER_LEFT_GAME = "Player 1 left the game";
...
// ---------------- M_Menu.C ----------------
constexpr auto PRESSKEY = "press any button.";
constexpr auto PRESSYN = "press y or n.";
constexpr auto QUITMSG = "are you sure you want to\nquit this great game?";

constexpr auto LOADNET = concat("you can't do load while in a net game!\n\n", PRESSKEY);
constexpr auto QLOADNET = concat("you can't quickload during a netgame!\n\n", PRESSKEY);
constexpr auto QSAVESPOT = concat("you haven't picked a quicksave slot yet!\n\n", PRESSKEY);
constexpr auto SAVEDEAD = concat("you can't save if you aren't playing!\n\n", PRESSKEY);
constexpr auto SAVEDEAD2 = concat("you can't save if you're dead!\n\n", PRESSKEY);
constexpr auto QSPROMPT = concat("quicksave over your game named\n\n'%s'?\n\n", PRESSYN);
constexpr auto QLPROMPT = concat("do you want to quickload the game named\n\n'%s'?\n\n", PRESSYN);
...
constexpr auto NETEND = concat("you can't end a netgame!\n\n", PRESSKEY);
constexpr auto ENDGAME = concat("are you sure you want to end the game?\n\n", PRESSYN);

constexpr auto DOSY = "(press A to quit)";
...
constexpr auto HUSTR_11 = "level 11: circle of death";
...
constexpr auto HUSTR_31 = "level 31: idkfa";
constexpr auto HUSTR_32 = "level 32: keen";
constexpr auto HUSTR_33 = "level 33: betray";
...
// ---------------- F_Finale.C ----------------
// (These were multi-line single defines originally; keep as single literals.)
...
// NET
constexpr auto NET_PLAYER_DISCONNECTED = "You have been disconnected from the match.";
constexpr auto NET_PLAYER1_DISCONNECT = "Player 1 has left the game";
