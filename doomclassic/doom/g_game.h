...
// GAME
//
void G_DeathMatchSpawnPlayer (index_t playernum);
...
void G_DeferedInitNew (skill_t skill, index_t episode, index_t map);
...
void G_SaveGame (index_t slot, const char* description);
